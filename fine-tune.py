...
from fine_tuning.api_clients import get_github_client, get_openai_client, validate_openai_api_key
...
def main():
    ...
    fine_tuner = FineTuner(openai_client, config)
...
# Wrap main execution in a try-except block
if __name__ == "__main__":
    main()